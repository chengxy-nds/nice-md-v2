...
export const materials = [
  // ── 135 完美复刻爆款 (图二素材) ──
  {
    ...
    html: `<section style="margin: 24px 0 16px; padding: 12px 10px; position: relative;">
  <div style="display: flex; align-items: flex-end; gap: 8px; margin-bottom: 6px;">
    <!-- 倾斜黄色标牌 -->
    <div style="background: #facc15; color: #ffffff; font-weight: 800; font-size: 13px; padding: 3px 10px; border-radius: 4px; transform: rotate(-6deg); box-shadow: 2px 2px 0px rgba(245,158,11,0.2); display: inline-block; letter-spacing: 0.5px; font-family: -apple-system, sans-serif;">
      PART.01
    </div>
    <!-- 弧形小箭头 -->
    <svg width="28" height="18" viewBox="0 0 28 18" fill="none" style="margin-left: 2px; margin-bottom: -1px;">
  ...
  <div style="display: flex; align-items: center; gap: 8px;">
    <div style="display: inline-block;">
      <span style="font-size: 18px; font-weight: 800; color: #2e8b57; letter-spacing: 1px; font-family: 'PingFang SC', 'Microsoft YaHei', sans-serif;">
        八月拾夏 静待秋风
      </span>
      <!-- 双波浪线 -->
  ...
  // ── 标题/序号素材 ──
  {
    ...
    tags: ['135热选', '序号标题', '蓝色'],
    html: `<section style="margin: 24px 0 16px; display: flex; align-items: center;">
  <span style="display: inline-flex; align-items: center; justify-content: center; background: #2563eb; color: #ffffff; font-size: 15px; font-weight: 800; width: 34px; height: 34px; border-radius: 50%; margin-right: 12px; box-shadow: 0 4px 10px rgba(37,99,235,0.3); flex-shrink: 0;">01</span>
  ...
  },
  {
    ...
    tags: ['135热选', '明黄', '立体风'],
    html: `<section style="margin: 24px 0 16px; display: inline-block;">
  ...
  },
  {
    ...
    tags: ['莫兰迪', '高级感', '拼接'],
    html: `<section style="margin: 22px 0 14px; display: flex; align-items: stretch; border-radius: 6px; overflow: hidden; max-width: max-content;">
  <span style="background: #a3b18a; color: #ffffff; font-weight: 800; font-size: 13px; padding: 6px 12px; display: flex; align-items: center; letter-spacing: 0.5px;">SECTION</span>
  ...
  },
  {
    ...
    tags: ['国风', '朱红', '宋体'],
    html: `<section style="margin: 26px 0 16px; text-align: center;">
  <div style="display: inline-block; padding: 6px 24px; border-top: 2px solid #991b1b; border-bottom: 2px solid #991b1b; background: #fff5f5;">
    <span style="font-family: 'SimSun', 'Songti SC', serif; font-size: 16.5px; font-weight: 700; color: #991b1b; letter-spacing: 2px;">❖ 闲情记趣 · 岁时节气 ❖</span>
  </div>
</section>`
  },
  {
    ...
    tags: ['包边标题', '绿色', '极简'],
    html: `<section style="margin: 22px 0 14px; padding: 8px 16px; border-left: 4px solid #10b981; background: #ecfdf5; border-radius: 0 8px 8px 0;">
  <span style="font-size: 16px; font-weight: 700; color: #065f46;">构建持续交付的自动化 SOP</span>
</section>`
  },
  {
    id: 'h-center-line',
    ...
    tag: '总结',
    title: '经典双划线居中总结标题',
    description: '带有左右虚线/实线装饰的居中标题，适合章节分隔',
    tags: ['居中标题', '修饰线', '总结'],
    html: `<section style="text-align: center; margin: 26px 0 16px;">
  <span style="color: #cbd5e1; margin: 0 12px;">───</span>
  <span style="font-size: 15.5px; font-weight: 700; color: #0f172a; padding: 4px 16px; background: #f1f5f9; border-radius: 20px;">核心视角与复盘总结</span>
  <span style="color: #cbd5e1; margin: 0 12px;">───</span>
</section>`
  },
  {
    ...
    tags: ['黑金', '科技感', '数码'],
    html: `<section style="margin: 24px 0 16px; background: #0f172a; padding: 10px 18px; border-left: 4px solid #f59e0b; border-radius: 0 8px 8px 0; display: flex; align-items: center; gap: 10px;">
  <span style="color: #f59e0b; font-size: 18px;">⚡</span>
  <span style="font-size: 15.5px; font-weight: 700; color: #f8fafc; letter-spacing: 0.5px;">GenAI 大模型在业务落地的痛点剖析</span>
</section>`
  },
  ...
  // ── 分割线素材 ──
  {
    ...
    tags: ['剪刀', '裁剪', '趣味'],
    html: `<section style="display: flex; align-items: center; margin: 26px 0; color: #94a3b8; font-size: 14px;">
  ...
  <div style="display: flex; justify-content: center; gap: 16px; color: #475569; font-size: 13px; font-weight: 600;">
